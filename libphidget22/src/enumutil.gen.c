...
Phidget_enumFromString(const char *name) {
	...
	if (mos_strcasecmp(name, "PHIDID_DCC1004") == 0)
		return (128);

	if (mos_strcasecmp(name, "PHIDID_DCC1005") == 0)
		return (129);

	if (mos_strcasecmp(name, "PHIDID_SPT_PROTO") == 0)
		return (131);

	if (mos_strcasecmp(name, "PHIDID_ADP_RS232") == 0)
		return (132);

	if (mos_strcasecmp(name, "PHIDID_ADP_RS485_422") == 0)
		return (133);

	if (mos_strcasecmp(name, "PHIDID_ADP_SERIAL") == 0)
		return (134);

	if (mos_strcasecmp(name, "PHIDID_1067_1") == 0)
		return (135);

	if (mos_strcasecmp(name, "PHIDID_HUM1100") == 0)
		return (136);

	if (mos_strcasecmp(name, "PHIDID_VINTSPATIAL") == 0)
		return (137);

	if (mos_strcasecmp(name, "PHIDID_VINTACCEL") == 0)
		return (138);

	if (mos_strcasecmp(name, "PHIDID_TP_DIAGNOSER") == 0)
		return (139);
...
Phidget_enumString(const char *family, int id) {
	...
	if (mos_strcasecmp(family, "Parity") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "StopBits") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "HandshakeMode") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "Protocol") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "SPIMode") == 0) {
		switch (id) {
		case 1:
			return ("SPI_MODE_0");
		case 2:
	...
	if (mos_strcasecmp(family, "Endianness") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "IOVoltage") == 0) {
		switch (id) {
		case 1:
...
supportedDeviceID(PhidgetChannelHandle ch, Phidget_DeviceID val) {
	...
	case PHIDCHUID_1024_RFID_200_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1024:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_1024_DIGITALOUTPUT_5V_200_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1024:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_1024_DIGITALOUTPUT_LED_200_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1024:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_1024_DIGITALOUTPUT_ONBOARD_LED_200_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1024:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DATAADAPTER_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
			return (1);
		default:
			return (0);
		}
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_DSR_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_DCD_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_RI_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALOUTPUT_DTR_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_DSR_100_VINT:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_DCD_100_VINT:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_RI_100_VINT:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_RS232_DIGITALOUTPUT_DTR_100_VINT:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_RS232:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_SERIAL_DATAADAPTER_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_SERIAL:
		case PHIDID_1067_1:
			return (1);
		default:
			return (0);
		}
	case PHIDCHUID_ADP_SERIAL_DIGITALINPUT_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_SERIAL:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_ADP_SERIAL_DIGITALOUTPUT_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP_SERIAL:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_VINTACCEL_ACCELEROMETER_100:
		...
		case PHIDID_NOTHING:
		case PHIDID_1067_1:
		case PHIDID_VINTACCEL:
			return (1);
		default:
			return (0);
		}
	case PHIDCHUID_VINTSPATIAL_ACCELEROMETER_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1067_1:
		case PHIDID_VINTSPATIAL:
			return (1);
		default:
			return (0);
		}
	case PHIDCHUID_VINTSPATIAL_GYROSCOPE_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1067_1:
		case PHIDID_VINTSPATIAL:
	...
	case PHIDCHUID_VINTSPATIAL_MAGNETOMETER_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1067_1:
		case PHIDID_VINTSPATIAL:
	...
	case PHIDCHUID_VINTSPATIAL_SPATIAL_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_1067_1:
		case PHIDID_VINTSPATIAL:
	...
	case PHIDCHUID_SPT_PROTO_ACCELEROMETER_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_SPT_PROTO:
		case PHIDID_1067_1:
			return (1);
		default:
			return (0);
		}
	case PHIDCHUID_SPT_PROTO_GYROSCOPE_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_SPT_PROTO:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_SPT_PROTO_MAGNETOMETER_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_SPT_PROTO:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_SPT_PROTO_SPATIAL_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_SPT_PROTO:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_SPT_PROTO_TEMPERATURESENSOR_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_SPT_PROTO:
		case PHIDID_1067_1:
	...
	case PHIDCHUID_HUB0000_HUB_200:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_HUB0000:
		case PHIDID_1067_1:
...
int
supportedParity(PhidgetChannelHandle ch, PhidgetDataAdapter_Parity val) {
...
int
supportedStopBits(PhidgetChannelHandle ch, PhidgetDataAdapter_StopBits val) {
...
int
supportedHandshakeMode(PhidgetChannelHandle ch, PhidgetDataAdapter_HandshakeMode val) {

	switch (ch->UCD->uid) {
	case PHIDCHUID_ADP_RS232_DATAADAPTER_100_USB:
		switch (val) {
		case HANDSHAKE_MODE_NONE:
		case HANDSHAKE_MODE_REQUEST_TO_SEND:
		case HANDSHAKE_MODE_READY_TO_RECEIVE:
			return (1);
		default:
			return (0);
		}
...
int
supportedProtocol(PhidgetChannelHandle ch, PhidgetDataAdapter_Protocol val) {
...
int
supportedSPIMode(PhidgetChannelHandle ch, PhidgetDataAdapter_SPIMode val) {
...
int
supportedEndianness(PhidgetChannelHandle ch, PhidgetDataAdapter_Endianness val) {

	switch (ch->UCD->uid) {
	case PHIDCHUID_ADP_RS232_DATAADAPTER_100_USB:
		switch (val) {
		case ENDIANNESS_MSB_FIRST:
		case ENDIANNESS_LSB_FIRST:
			return (1);
		default:
			return (0);
		}
...
int
supportedIOVoltage(PhidgetChannelHandle ch, PhidgetDataAdapter_IOVoltage val) {

	switch (ch->UCD->uid) {
	case PHIDCHUID_ADP_SERIAL_DATAADAPTER_100_USB:
		switch (val) {
		case IO_VOLTAGE_EXTERN:
		case IO_VOLTAGE_1_8V:
		case IO_VOLTAGE_2_5V:
		case IO_VOLTAGE_3_3V:
		case IO_VOLTAGE_5_0V:
			return (1);
		default:
			return (0);
		}
