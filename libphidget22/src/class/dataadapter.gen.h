...
API_PRETURN_HDR PhidgetDataAdapter_getLastData(PhidgetDataAdapterHandle ch, uint8_t *data,
  size_t *dataLen, int *lastDataError);
...
API_PRETURN_HDR PhidgetDataAdapter_sendPacketWaitResponse(PhidgetDataAdapterHandle ch,
  const uint8_t *sendData, size_t sendDataLen, uint32_t milliseconds, uint8_t *recvData, size_t *recvDataLen, int *error);
...
API_PRETURN_HDR PhidgetDataAdapter_getStopBits(PhidgetDataAdapterHandle ch,
  PhidgetDataAdapter_StopBits *stopBits);
API_PRETURN_HDR PhidgetDataAdapter_setTimeout(PhidgetDataAdapterHandle ch, uint32_t timeout);
API_PRETURN_HDR PhidgetDataAdapter_getTimeout(PhidgetDataAdapterHandle ch, uint32_t *timeout);
API_PRETURN_HDR PhidgetDataAdapter_getMinTimeout(PhidgetDataAdapterHandle ch, uint32_t *minTimeout);
API_PRETURN_HDR PhidgetDataAdapter_getMaxTimeout(PhidgetDataAdapterHandle ch, uint32_t *maxTimeout);
