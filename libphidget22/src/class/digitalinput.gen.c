/* Generated: Tue Nov 17 2020 09:43:16 GMT-0700 (Mountain Standard Time) */
...
_initAfterOpen(PhidgetChannelHandle phid) {
	...
	PhidgetDataAdapterDeviceHandle parentDataAdapter;
	...
	parentDataAdapter = (PhidgetDataAdapterDeviceHandle)phid->parent;
	...
	case PHIDCHUID_ADP_RS232_DIGITALINPUT_DSR_100_USB:
		ch->state = parentDataAdapter->inputState[ch->phid.index];
		break;
